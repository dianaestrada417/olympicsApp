...
// import { StyleSheet, Text, View, Dimensions, ActivityIndicator, TextInput, Button, FlatList, TouchableOpacity, KeyboardAvoidingView, Platform } from 'react-native';
...
function HomeScreen() {
  return (
    <View style={styles.container}>
      <Text>How to Survive LA - Olympics '28 Edition</Text>
      <Image
        style={styles.gif}
        source={require('./assets/olympics.gif')}
        contentFit="contain"
