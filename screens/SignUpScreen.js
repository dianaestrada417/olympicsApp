...
import { Text, View, Dimensions, TextInput, TouchableOpacity, ScrollView, StyleSheet, Button } from 'react-native';
...
const SignUpScreen = ({ navigation, setFormSubmitted,setUserData }) => {
    ...
    useEffect(() => {
      // Disable drawer gestures until the form is submitted
      navigation.setOptions({
        swipeEnabled: false, // Disable gestures initially
      });
    }, [navigation]);
    ...
    const handleSubmit = async () => {
      ...
      try {
        ...
        navigation.setOptions({
          swipeEnabled: true, // Enable gestures once form is submitted
        });
